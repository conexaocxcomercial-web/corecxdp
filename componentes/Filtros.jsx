      ...
      {busca ? (
        <div className="relative min-w-[220px] flex-1">
          <svg
            viewBox="0 0 16 16"
            aria-hidden="true"
            className="pointer-events-none absolute left-3 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-tinta-30"
          >
          ...
          <input
            ...
            placeholder={busca}
            aria-label={busca}
            className="h-9 w-full rounded-md border border-[#C7D0D9] bg-folha pl-9 pr-3 text-campo transition-colors hover:border-tinta-30 focus:border-carimbo"
          />
        </div>
      ) : null}
      ...
      {seletores.map((seletor) => (
        <div key={seletor.chave} className="relative">
          <select
            ...
            className="h-9 appearance-none rounded-md border border-[#C7D0D9] bg-folha pl-3 pr-8 text-campo transition-colors hover:border-tinta-30 focus:border-carimbo"
          >
          ...
          <svg
            viewBox="0 0 12 12"
            aria-hidden="true"
            className="pointer-events-none absolute right-2.5 top-1/2 h-3 w-3 -translate-y-1/2 text-tinta-50"
          >
